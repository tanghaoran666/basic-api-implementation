...
class UserControllerTest {
    ...
    public void should_add_user() throws Exception {
        ...
        mockMvc.perform(post("/rs/user").content(jsonString).contentType(MediaType.APPLICATION_JSON))
    ...
    public void should_get_user_in_data_base() throws Exception {
        ...
        mockMvc.perform(get("/rs/user/{id}",savedUserPo.getId()))
    ...
    public void should_delete_user_in_database() throws Exception {
        ...
        mockMvc.perform(delete("/rs/user/{id}",savedUserPo.getId()))
                .andExpect(status().isOk());
